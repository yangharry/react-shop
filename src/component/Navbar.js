...
function Navbar() {
  ...
  return (
    <div className="p-2 text-2xl w-full shadow-md h-12 flex items-center justify-between min-w-max">
      <div>
        <span className="font-bold pl-4 cursor-pointer" onClick={() => navigate('/')}>
          Shop
        </span>
      </div>
      <div className="text-2xl flex">
        <div className="pr-3 cursor-pointer relative" onClick={() => navigate('/cart')}>
          {cart.length !== 0 && (
        ...
        {user ? (
          ...
          <div className="pr-3 cursor-pointer" onClick={() => navigate('/login')}>
